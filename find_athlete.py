...
def request_data():
    ...
    print("Давай сравним атлетов и одного из пользователей.")
...
def main():
    ...
    if not user:
        ...
        bd_athlete, bd = match_bd(user, session)
        height_athlete, height = match_height(user, session)
        print(
